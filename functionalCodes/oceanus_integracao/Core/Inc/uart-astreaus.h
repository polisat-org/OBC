...
#define PL_START_PIN GPIO_PIN_4
#define PL_END_PIN GPIO_PIN_2

#define TTC_BUSY_PORT GPIOC
#define ADCS_ON_OFF_PORT GPIOB
#define PL_START_PORT GPIOC
#define PL_END_PORT GPIOB
